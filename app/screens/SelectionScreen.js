        ...
        <View style={{ justifyContent: "center", alignItems: "center", width: "100%" }}>
          ...
          >
            <View style={{ width: "95%", justifyContent: "center", alignItems: "center", alignSelf: "center" }}>
              <Text style={{ textAlign: "center", color: Colors.white, fontSize: RFPercentage(2.6), fontFamily: "VarelaRound_400Regular" }}>מעונין / רוצה למסור</Text>
            </View>
          </TouchableOpacity>
          {/* Second */}
          <TouchableOpacity
          ...
          >
            <View style={{ width: "95%", justifyContent: "center", alignItems: "center", alignSelf: "center" }}>
              <Text style={{ textAlign: "center", color: Colors.white, fontSize: RFPercentage(2.6), fontFamily: "VarelaRound_400Regular" }}>רוצה לאסוף</Text>
            </View>
          </TouchableOpacity>
        </View>
