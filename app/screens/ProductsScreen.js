  ...
  return (
    <Screen style={styles.screen}>
      ...
      <View style={{ marginTop: RFPercentage(2.5), width: "90%", justifyContent: "flex-start", alignItems: "flex-start" }}>
        <MaterialCommunityIcons name="filter-menu-outline" style={{ fontSize: RFPercentage(3.8) }} color={Colors.primary} />
      </View>
      <View style={{ marginTop: RFPercentage(0), width: "100%" }}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View style={{ marginTop: RFPercentage(2.2), width: "90%", flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
            ...
            >
              <Text style={{ color: category == "Furniture" ? Colors.white : "#4A4542", fontSize: RFPercentage(2), fontFamily: "VarelaRound_400Regular" }}>רְהִיטִים</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.5}
            ...
            >
              <Text style={{ color: category == "Appliances" ? Colors.white : "#4A4542", fontSize: RFPercentage(2), fontFamily: "VarelaRound_400Regular" }}>מכשירים</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.5}
            ...
            >
              <Text style={{ color: category == "Clothing/Footwear" ? Colors.white : "#4A4542", fontSize: RFPercentage(2), fontFamily: "VarelaRound_400Regular" }}>ביגוד/הנעלה</Text>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.5}
            ...
            >
              <Text style={{ color: category == "Sport" ? Colors.white : "#4A4542", fontSize: RFPercentage(2), fontFamily: "VarelaRound_400Regular" }}>ספּוֹרט</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </View>
      ...
      <ScrollView style={{ flex: 1, width: "100%", marginTop: RFPercentage(3) }}>
        <View style={{ justifyContent: "center", alignItems: "center", width: "100%" }}>
          {products?.length > 0 ? (
              ...
              <>
                ...
                >
                  ...
                  <View style={{ marginTop: RFPercentage(10), width: "70%", flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                    <Text style={{ marginLeft: RFPercentage(-4), color: Colors.primary, fontSize: RFPercentage(2), fontFamily: "VarelaRound_400Regular" }}>{item?.productname}</Text>
                  </View>
                  ...
                  <View style={{ marginTop: RFPercentage(2), width: "70%", flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                    ...
                    >
                      <Text style={{ color: Colors.white, fontSize: RFPercentage(1.8), fontFamily: "VarelaRound_400Regular" }}>פרטים</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                    ...
                    >
                      <Text style={{ color: Colors.green, fontSize: RFPercentage(1.8), fontFamily: "VarelaRound_400Regular" }}>הוספת פריט</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </>
            ...
            <>
              <Text style={{ marginTop: RFPercentage(25), fontSize: RFPercentage(2.5), color: Colors.primary, fontFamily: "VarelaRound_400Regular" }}>No Product Added to Load</Text>
